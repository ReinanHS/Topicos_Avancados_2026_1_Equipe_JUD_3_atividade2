...
class VictorExtractor(EriclesExtractor):
    """
    Extrator para as questoes do Victor.

    A inferencia e a curadoria das questoes da Victor foram executadas dentro
    do repositorio da Atividade 1 do Ericles, entao reaproveitamos o mesmo `base_raw_url` e o mesmo formato
